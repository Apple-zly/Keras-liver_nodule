...
from metrics_m import dice_liver, dice_lesion
import os
...
#  data folder
parser.add_argument('-data', type=str, default='/home/data/zly/livernodule/data/', help='test images')
parser.add_argument('-save_path', type=str, default='/home/data/zly/livernodule/result/2d_12/')
#  other paras
...
def generate_arrays_from_file(batch_size, trainidx, img_list, tumor_list, tumorlines, liverlines, tumoridx, liveridx, minindex_list, maxindex_list):
    while 1:
        ...
        for idx in range(batch_size):
            count = random.choice(trainidx)  #一个batch的样本随机选择
            img = img_list[count]
...
def load_fast_files(args):
    ...
    for idx in range(80):
        ...
        tumor, tumor_header = load('/home/data/LITS/Training_Batch/segmentation-' + str(idx) + '.nii')
        img_list.append(img)
